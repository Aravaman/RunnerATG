...
IL_009a:
	{
		...
		L_27 = KeyValuePair_2_get_Value_mE39A30B30789EC1AEE5F456DE6E59B2F7C776010_inline(((L_25)->GetAddressAtUnchecked(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 15));
...
{
	{
		...
		L_0 = ((  ValueCollection_t157CDE1BB51D15D35E654612D8A347E8CCC5640B* (*) (Dictionary_2_tF359FBE569767892CF7201F5C5758F7257E84F13*, const RuntimeMethod*))il2cpp_codegen_get_method_pointer(il2cpp_rgctx_method(method->klass->rgctx_data, 49)))(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 49));
		return (RuntimeObject*)L_0;
	}
}
